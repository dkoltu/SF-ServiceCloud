        ...
        for (var i = 0; i < prechatFieldComponents.length; i++) {
            ...
            if (pcField.get("v.required")) {
                ...
                if (pcField.get("v.label") === "Subject") {
                    ...
                    var value2 = value1.replace(visaRegEx1, subst);

                    var value3 = value2.replace(chinaUnionRegEx1, subst);

                    var value4 = value3.replace(dankortRegEx1, subst);

                    var value5 = value4.replace(dinersClubRegEx1, subst);
                    var value6 = value5.replace(dinersClubRegEx2, subst);
                    var value7 = value6.replace(dinersClubRegEx3, subst);

                    var value8 = value7.replace(dinersClubCartBlancheRegEx1, subst);
                    var value9 = value8.replace(dinersClubCartBlancheRegEx2, subst);
                    var value10 = value9.replace(dinersClubCartBlancheRegEx3, subst);

                    var value11 = value10.replace(discoverRegEx1, subst);
                    var value12 = value11.replace(discoverRegEx2, subst);
                    var value13 = value12.replace(discoverRegEx3, subst);

                    var value14 = value13.replace(instapaymentRegEx1, subst);

                    var value15 = value14.replace(interpaymentRegEx1, subst);

                    var value16 = value15.replace(jcbRegEx1, subst);

                    var value17 = value16.replace(maestroRegEx1, subst);

                    var value18 = value17.replace(mastercardRegEx1, subst);

                    var value19 = value18.replace(soloRegEx1, subst);

                    var value20 = value19.replace(uatpRegEx1, subst);

                    if (value !== null && value !== "" && value !== undefined) {
                        pcField.set("v.value", value20);
                    }
                }
            }
